...
## 1. P1 本周发 · Claude Code Routines

**写什么**: 以 Claude Code Routines 引发的开发者效率讨论为切入点

**发到哪**: Reddit（直接参与讨论） + LinkedIn（发教程文章） + Discord（开发者社区互动）

**参考文案**:
> 🤖 "Claude Code Routines" shows the power of AI coding! We built CodeBuddy with similar vision — AI-powered IDE covering requirements→design→code→test. Try the Agent mode: https://www.tencentcloud.com/products/codebuddy #AICoding #DevTools

*参考: [Claude Code Routines](https://code.claude.com/docs/en/routines)*
...
## 3. P1 本周发 · thedotmack/claude-mem
...
## 5. P1 本周发 · # 🐱 送懒猫微服！送 CodeX 啦！（第二轮）

**写什么**: 借「送懒猫微服送啦第」的讨论热度写一篇 AI 编程工具选型指南

**发到哪**: Reddit（直接参与讨论） + LinkedIn（发教程文章） + Discord（开发者社区互动）

**参考文案**:
> 🤖 "# 🐱 送懒猫微服！送 CodeX 啦！（第二轮）" shows the power of AI coding! We built CodeBuddy with similar vision — AI-powered IDE covering requirements→design→code→test. Try the Agent mode: https://www.tencentcloud.com/products/codebuddy #AICoding #DevTools

*参考: [# 🐱 送懒猫微服！送 CodeX 啦！（第二轮）](https://www.v2ex.com/t/1205888)*
